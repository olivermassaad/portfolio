...
export const homeDetails = {
  ...
  "profile-founder": {
    ...
    gallery: [
      ...
      { type: "image", src: "/gallery/lazy-dawg-5.png", alt: "Lazy Dawg title screen" },
  ...
  "profile-musician": {
    ...
    gallery: [
      ...
      { type: "image", src: "/gallery/pinkeye-1.png", alt: "PinkEye 1" },
      { type: "image", src: "/gallery/pinkeye-2.png", alt: "PinkEye 2" },
      { type: "image", src: "/gallery/pinkeye-3.png", alt: "PinkEye 3" },
      { type: "image", src: "/gallery/piano-1.jpg", alt: "Piano 1" },
      { type: "image", src: "/gallery/piano-2.jpg", alt: "Piano 2" },
  ],
  },
  "education-dawson": {
  ...
  "achievement-dawson-music-club": {
    ...
    gallery: [
      { type: "image", src: "/gallery/dawson-music-club-3.png", alt: "Dawson Music Club 3" },
  ...
  "achievement-concours-castor-2022": {
    ...
    gallery: [
      { type: "image", src: "/gallery/concours-castor.png", alt: "Concours Castor 1" },
    ],
  },
  "project-nebula-ai": {
    title: "Nebula AI",
