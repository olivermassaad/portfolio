...
export const homeDetails = {
  ...
  "profile-founder": {
    ...
    gallery: [
      { type: "image", src: "/gallery/nebula-ai-1.webp", alt: "Nebula AI title screen" },
  ...
  "profile-musician": {
    ...
    gallery: [
      ...
      { type: "image", src: "/gallery/rezone-4.webp", alt: "RE:ZONE 4" },
  ...
  "project-nebula-ai": {
    ...
    gallery: [
      { type: "image", src: "/gallery/nebula-ai-1.webp", alt: "Nebula AI 1" },
      { type: "image", src: "/gallery/nebula-ai-2.webp", alt: "Nebula AI 2" },
      { type: "image", src: "/gallery/nebula-ai-3.webp", alt: "Nebula AI 3" },
      { type: "image", src: "/gallery/nebula-ai-4.webp", alt: "Nebula AI 4" },
      { type: "image", src: "/gallery/nebula-ai-5.webp", alt: "Nebula AI 5" },
      { type: "image", src: "/gallery/nebula-ai-6.webp", alt: "Nebula AI 6" },
      { type: "image", src: "/gallery/nebula-ai-7.webp", alt: "Nebula AI 7" },
    ],
  },
  "project-nebula-life": {
    title: "Nebula Life",
  ...
  "project-nook": {
    ...
    gallery: [
      { type: "image", src: "/gallery/nook-5.webp", alt: "Nook 5" },
  ...
  "project-astraipt": {
    ...
    gallery: [
      { type: "image", src: "/gallery/astra-ipt.webp", alt: "AstraIPT" },
    ],
  },
  "project-maeve-cherry-blossom": {
    ...
    gallery: [
      { type: "image", src: "/gallery/cherry-blossom-1.webp", alt: "Maeve Catalog Cherry Blossom 1" },
  ...
  "project-maeve-amethyst": {
    ...
    gallery: [
      { type: "image", src: "/gallery/amethyst-1.webp", alt: "Maeve Catalog Amethyst Cave 1" },
  ...
  "project-maeve-beach": {
    ...
    gallery: [
      { type: "image", src: "/gallery/beach-1.webp", alt: "Maeve Catalog Beach 1" },
