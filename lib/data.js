export const projects = [
  {
    ...
    description:
      "Designed and developed multiple AI-powered daily-life applications, working across backend logic and frontend interfaces.",
  },
  {
    name: "Nook",
  ...
  },
  {
    ...
    description:
      "Created 3D models, environments, and animations for ad-style Roblox content featuring characters wearing Maeve Catalog outfits.",
  },
  {
    name: "Forge",
    description:
      "Designed and developed a social platform concept focused on self-improvement content, goal tracking, workouts, and community accountability.",
  },
];
...
export const achievements = [
  ...
  },
  {
    ...
    team: "",
    description: "Award recipient among 200+ participants.",
    details: [
      "Presented a healthcare-focused concept to the judging panel.",
      "Recognized for quality of execution and presentation in a 200+ participant event.",
    ],
  },
  {
    slug: "aerohacks-2026",
  ...
  },
  {
    ...
    details: [
      "Won the Gemini API category with a practical AI integration.",
      "Built and delivered a polished hackathon demo among 150+ participants.",
    ],
  ...
  },
  {
    ...
    details: ["Contributed to research, hosting, and recording preparation."],
    external_url:
  ...
  },
  {
    ...
    details: ["Participated in interview preparation and on-air journalism segments."],
    external_url:
  ...
  },
  {
    ...
    details: ["Worked on content preparation and educational communication."],
    external_url:
  ...
  },
  {
    ...
    details: ["Competed against international participants from multiple institutions."],
  },
];
