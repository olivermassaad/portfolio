  ...
  useEffect(() => {
    ...
    const program = new Program(gl, {
      ...
      uniforms: {
        ...
        uColorStops: { value: toRgbTriplets(colorStops) },
    ...
    const update = (time) => {
      ...
      program.uniforms.uTime.value = time * 0.001 * (current.speed ?? 1.0);
      program.uniforms.uAmplitude.value = current.amplitude ?? 1.0;
      program.uniforms.uBlend.value = current.blend ?? 0.5;
      program.uniforms.uColorStops.value = toRgbTriplets(current.colorStops ?? colorStops);
